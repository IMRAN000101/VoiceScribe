...
` +
    ...
    function Kr(e) {
      ...
      var t = Wr[e],
        n;
      for (n in t) if (t.hasOwnProperty(n) && n in Gr) return (j[e] = t[n]);
      return e;
    }
    ...
    function Ti(e, t) {
      if (typeof e == `object` && e) {
        var n = wi.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: Oe(t) }), wi.set(e, t), t)
          : n;
      }
    ...
    function Bo(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Ar(o, e.memoizedState) && ((V = !0), d && ((n = va), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    var Rl = {
      ...
      fu = null;
    function pu() {
      return G & 2 && J !== 0 ? J & -J : E.T === null ? ft() : dd();
    }
    function mu() {
      if (Jl === 0)
        if (!(J & 536870912) || N) {
...
function ue(e, t, n, r, i) {
  let a = Oe((typeof t == `string` ? ce(t) : t).pathname || `/`, n);
...
function pe(e, t = [], n = [], r = ``, i = !1) {
  ...
  return (
    e.forEach((e, t) => {
      ...
      else for (let n of O(e.path)) a(e, t, !0, n);
    }),
    t
  );
}
...
function xe(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !be(e))
      .reduce((e, t) => e + (me.test(t) ? he : t === `` ? _e : ve), r)
  );
}
function Se(e, t) {
    ...
    let s = r[e],
      ...
      d =
        s.matcher && s.compiledParams
          ? Te(u, l, s.matcher, s.compiledParams)
          : we(u, l),
      f = s.route;
    if (
      (!d &&
...
function ke(e, t = `/`) {
  let {
      ...
      search: r = ``,
      hash: i = ``,
    } = typeof e == `string` ? ce(e) : e,
    a;
  return (
    n
      ? ((n = Fe(n)),
        (a = n.startsWith(`/`) ? Ae(n.substring(1), `/`) : Ae(n, t)))
      : (a = t),
...
function Ye(e) {
  try {
    return Je.includes(new URL(e).protocol);
  } catch {
    return !1;
  }
}
var Xe = x.createContext(null);
Xe.displayName = `DataRouter`;
var Ze = x.createContext(null);
Ze.displayName = `DataRouterState`;
var Qe = x.createContext(!1);
function $e() {
  return x.useContext(Qe);
}
var et = x.createContext({ isTransitioning: !1 });
et.displayName = `ViewTransition`;
var tt = x.createContext(new Map());
tt.displayName = `Fetchers`;
...
var at = x.createContext({ outlet: null, matches: [], isDataRoute: !1 });
at.displayName = `Route`;
var ot = x.createContext(null);
ot.displayName = `RouteError`;
var st = `REACT_ROUTER_ERROR`,
  ct = `REDIRECT`,
  lt = `ROUTE_ERROR_RESPONSE`;
function ut(e) {
  if (e.startsWith(`${st}:${ct}:{`))
    try {
...
function ft(e, { relative: t } = {}) {
  w(pt(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = x.useContext(rt),
    { hash: i, pathname: a, search: o } = yt(e, { relative: t }),
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : Ie([n, a])),
...
function mt() {
  return (
    ...
    x.useContext(it).location
  );
}
var ht = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function gt(e) {
  x.useContext(rt).static || x.useLayoutEffect(e);
}
function _t() {
  let { isDataRoute: e } = x.useContext(at);
  return e ? Rt() : vt();
}
function vt() {
  w(
  ...
  let e = x.useContext(Xe),
    { basename: t, navigator: n } = x.useContext(rt),
    { matches: r } = x.useContext(at),
    { pathname: i } = mt(),
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        if ((T(o.current, ht), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function yt(e, { relative: t } = {}) {
  let { matches: n } = x.useContext(at),
    { pathname: r } = mt(),
    i = JSON.stringify(Ne(n));
  return x.useMemo(() => Pe(e, JSON.parse(i), r, t === `path`), [e, i, r, t]);
}
function bt(e, t) {
  return xt(e, t);
}
function xt(e, t, n) {
  ...
  let { navigator: r } = x.useContext(rt),
    { matches: i } = x.useContext(at),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var Ct = x.createElement(St, null),
  wt = class extends x.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : x.createElement(
              ...
              x.createElement(ot.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? x.createElement(Et, { error: e }, t) : t;
    }
  };
wt.contextType = Qe;
var Tt = new WeakMap();
function Et({ children: e, error: t }) {
  let { basename: n } = x.useContext(rt);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
    ...
    if (e) {
      let r = Tt.get(t);
      if (r) throw r;
      let i = Ge(e.location, n),
        a = i.absoluteURL || i.to;
      if (Ye(a)) throw Error(`Invalid redirect location`);
      if (We && !Tt.get(t))
...
function Dt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    x.createElement(at.Provider, { value: e }, n)
  );
}
function Ot(e, t = [], n) {
  let r = n?.state;
...
function It() {
  let { matches: e, loaderData: t } = jt(`useMatches`);
  return x.useMemo(() => e.map((e) => de(e, t)), [e, t]);
}
function Lt() {
  let e = x.useContext(ot),
    t = jt(`useRouteError`),
    n = Nt(`useRouteError`);
  return e === void 0 ? t.errors?.[n] : e;
}
function Rt() {
  let { router: e } = At(`useNavigate`),
    t = Nt(`useNavigate`),
    n = x.useRef(!1);
  return (
    gt(() => {
...
function Ht({ to: e, replace: t, state: n, relative: r }) {
  ...
  let { static: i } = x.useContext(rt);
  T(
    !i,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`,
  );
  let { matches: a } = x.useContext(at),
    { pathname: o } = mt(),
    s = _t(),
    c = Pe(e, Ne(a), o, r === `path`),
    l = JSON.stringify(c);
  return (
    x.useEffect(() => {
  ...
  return (
    ...
    h == null
      ...
      : x.createElement(
          rt.Provider,
          { value: c },
          x.createElement(it.Provider, { children: t, value: h }),
        )
  );
}
  ...
  return (
    n
      ...
      : i.pathname === `/`
        ? (i.pathname = `_root.${r}`)
        : t && Oe(i.pathname, t) === `/`
          ? (i.pathname = `${Le(t)}/_root.${r}`)
          : (i.pathname = `${Le(i.pathname)}.${r}`),
    i
  );
}
...
function Dn({ page: e, ...t }) {
  let n = $e(),
    { nonce: r } = wn(),
    { router: i } = xn(),
    a = x.useMemo(() => D(i.routes, e, i.basename), [i.routes, e, i.basename]);
  return a
...
var Mn =
  ...
  window.document.createElement !== void 0;
try {
  Mn && (window.__reactRouterVersion = `7.18.0`);
} catch {}
...
var Fn = x.forwardRef(function (
  ...
  let { basename: h, navigator: g, useTransitions: _ } = x.useContext(rt),
    v = typeof l == `string` && ee.test(l),
    y = Ge(l, h);
  l = y.to;
  let b = ft(l, { relative: r }),
    S = mt(),
    C = null;
  if (o) {
  ...
  let ie = !(y.isExternal || i),
    ae = x.createElement(`a`, {
      ...p,
      ...re,
      href: (ie ? C : void 0) || y.absoluteURL || b,
      onClick: ie ? T : e,
      ref: jn(m, ne),
      target: c,
  ...
  return te && !v
    ? x.createElement(x.Fragment, null, ae, x.createElement(Dn, { page: b }))
    : ae;
});
Fn.displayName = `Link`;
var In = x.forwardRef(function (
  ...
  let u = yt(a, { relative: c.relative }),
    d = mt(),
    f = x.useContext(Ze),
    { navigator: p, basename: m } = x.useContext(rt),
    h = f != null && Qn(u) && o === !0,
...
var Ln = x.forwardRef(
  (
    ...
    let { useTransitions: h } = x.useContext(rt),
      g = Gn(),
      _ = Kn(s, { relative: l }),
...
function Yn(e, t, n, r) {
  ...
  return (
    r &&
      (i = r(
        n === `/` ? e : { ...e, pathname: Oe(e.pathname, n) || e.pathname },
        t,
      )),
    (i ??= e.key),
    i
...
function Qn(e, { relative: t } = {}) {
  ...
  let a = Oe(n.currentLocation.pathname, r) || n.currentLocation.pathname,
    o = Oe(n.nextLocation.pathname, r) || n.nextLocation.pathname;
...
var $n = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  er = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  tr = (e) =>
    ...
    (
      ...
      return (0, x.createElement)(
        `svg`,
        {
          ...
          ...rr,
          width: t ?? l ?? rr.width,
          height: t ?? l ?? rr.height,
          stroke: e ?? f,
          strokeWidth: m,
          className: $n(`lucide`, p, i),
  ...
  A = (e, t) => {
    let n = (0, x.forwardRef)(({ className: n, ...r }, i) =>
      (0, x.createElement)(sr, {
        ref: i,
        iconNode: t,
        className: $n(`lucide-${er(nr(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
    return ((n.displayName = nr(e)), n);
  },
  cr = A(`arrow-left`, [
  ...
  fr = A(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  pr = A(`chevron-down`, [[`path`, { d: `m6 9 6 6 6-6`, key: `qrunsl` }]]),
  mr = A(`chevron-right`, [[`path`, { d: `m9 18 6-6-6-6`, key: `mthhwq` }]]),
  hr = A(`circle-check`, [
  ...
  Wr = c(g(), 1),
  j = Ur();
function Gr({ light: e = !1 }) {
  return (0, j.jsxs)(`div`, {
    className: `flex items-center gap-2.5 font-bold text-lg`,
    children: [
      (0, j.jsx)(`span`, {
        className: `grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-lg shadow-indigo-200`,
        children: (0, j.jsx)(Ar, { size: 19 }),
      }),
      (0, j.jsxs)(`span`, {
        className: e ? `text-white` : `text-slate-900`,
        children: [
          `VoiceScribe `,
          (0, j.jsx)(`b`, { className: `text-brand`, children: `AI` }),
        ],
      }),
    ],
  });
}
function Kr({ children: e, variant: t = `primary`, className: n = ``, ...r }) {
  return (0, j.jsx)(`button`, {
    className: `inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold ${{ primary: `bg-brand text-white shadow-lg shadow-indigo-200 hover:bg-indigo-600 hover:-translate-y-0.5`, secondary: `bg-white text-slate-800 border border-slate-200 hover:border-indigo-200 hover:bg-indigo-50`, ghost: `text-slate-600 hover:text-brand hover:bg-indigo-50`, danger: `bg-white border border-red-200 text-red-600 hover:bg-red-50` }[t]} ${n}`,
    ...r,
    children: e,
  });
}
function qr({ children: e, className: t = `` }) {
  return (0, j.jsx)(`div`, {
    className: `rounded-2xl border border-slate-200 bg-white shadow-soft ${t}`,
    children: e,
  });
}
function Jr() {
  return (0, j.jsx)(`header`, {
    className: `sticky top-0 z-40 border-b border-slate-100 bg-white/85 backdrop-blur-xl`,
    children: (0, j.jsxs)(`div`, {
      className: `mx-auto flex h-18 max-w-7xl items-center justify-between px-5 py-4 lg:px-8`,
      children: [
        (0, j.jsx)(Fn, { to: `/`, children: (0, j.jsx)(Gr, {}) }),
        (0, j.jsxs)(`nav`, {
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, j.jsx)(In, {
              to: `/signup`,
              children: (0, j.jsx)(Kr, { children: `Get Started` }),
            }),
          ],
        }),
      ],
  ...
  return (0, j.jsxs)(`div`, {
    children: [
      ...
      (0, j.jsxs)(`main`, {
        children: [
          (0, j.jsxs)(`section`, {
            className: `relative overflow-hidden px-5 pb-24 pt-20 text-center lg:pb-32 lg:pt-28`,
            children: [
              (0, j.jsx)(`div`, {
                className: `grid-bg absolute inset-0 -z-20 [mask-image:linear-gradient(to_bottom,black,transparent)]`,
              }),
              (0, j.jsx)(`div`, {
                className: `absolute left-1/2 top-12 -z-10 h-96 w-96 -translate-x-1/2 rounded-full bg-indigo-200/50 blur-3xl`,
              }),
              (0, j.jsxs)(`div`, {
                className: `mx-auto max-w-5xl`,
                children: [
                  (0, j.jsxs)(`span`, {
                    className: `inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white px-4 py-2 text-xs font-semibold text-brand shadow-sm`,
                    children: [
                      (0, j.jsx)(Vr, { size: 14 }),
                  ...
                  (0, j.jsxs)(`h1`, {
                    className: `text-balance mt-7 text-5xl font-extrabold tracking-[-.045em] text-slate-950 md:text-7xl`,
                    children: [
                      `Turn speech into `,
                      (0, j.jsx)(`span`, {
                  ...
                  (0, j.jsx)(`p`, {
                    ...
                    children: `Record meetings, lectures, and conversations. Convert speech into text and unlock AI-powered insights.`,
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsxs)(Kr, {
                        ...
                        children: [
                          (0, j.jsx)(Mr, { size: 17, fill: `currentColor` }),
                          ` Watch Demo`,
                        ],
                      }),
                    ],
                  ...
                  (0, j.jsxs)(`div`, {
                    className: `mt-7 flex flex-wrap justify-center gap-5 text-xs text-slate-500`,
                    children: [
                      (0, j.jsxs)(`span`, {
          ...
          (0, j.jsx)(`section`, {
            id: `features`,
            className: `bg-slate-50 px-5 py-24`,
            children: (0, j.jsxs)(`div`, {
                ...
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, j.jsx)(`h2`, {
                      ...
                      children: `From conversation to clarity`,
                    }),
                    (0, j.jsx)(`p`, {
                      className: `mt-4 text-slate-500`,
                      children: `Spend less time taking notes and more time moving great work forward.`,
                    }),
                  ],
                }),
                (0, j.jsx)(`div`, {
                  className: `mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4`,
                  children: Yr.map(({ icon: e, title: t, text: n }) =>
                    (0, j.jsxs)(
                      qr,
                      {
                        className: `group p-6 hover:-translate-y-1 hover:border-indigo-200`,
                        children: [
                          (0, j.jsx)(`div`, {
                            className: `grid h-11 w-11 place-items-center rounded-xl bg-indigo-50 text-brand group-hover:bg-brand group-hover:text-white`,
                            children: (0, j.jsx)(e, { size: 21 }),
                          }),
                          (0, j.jsx)(`h3`, {
          ...
          (0, j.jsxs)(`section`, {
            ...
            children: [
              (0, j.jsx)(`h2`, {
                ...
                children: `Ready to remember everything?`,
              }),
              (0, j.jsx)(`p`, {
                className: `mt-3 text-slate-500`,
                children: `Your first five recordings are on us.`,
              }),
              (0, j.jsx)(Fn, {
                to: `/signup`,
                children: (0, j.jsxs)(Kr, {
        ...
        children: (0, j.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, j.jsx)(`p`, {
              ...
              children: `© 2026 VoiceScribe AI. Built for better conversations.`,
            }),
          ],
        }),
      }),
...
function $r({ label: e, type: t = `text`, icon: n, placeholder: r }) {
  return (0, j.jsxs)(`label`, {
    ...
    children: [
      ...
      (0, j.jsxs)(`span`, {
        className: `flex items-center gap-3 rounded-xl border bg-white px-3.5 py-3 focus-within:border-indigo-400 focus-within:ring-4 focus-within:ring-indigo-50`,
        children: [
          (0, j.jsx)(n, { size: 18, className: `text-slate-400` }),
          (0, j.jsx)(`input`, {
            type: t,
            placeholder: r,
  ...
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      (0, j.jsxs)(`section`, {
        ...
        children: [
          (0, j.jsx)(`div`, {
            className: `absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(99,102,241,.45),transparent_45%)]`,
          }),
          (0, j.jsx)(`div`, {
            className: `relative`,
            children: (0, j.jsx)(Gr, { light: !0 }),
          }),
          (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsx)(`p`, {
                ...
                children: `VOICE INTELLIGENCE, SIMPLIFIED`,
              }),
              (0, j.jsx)(`h1`, {
                className: `mt-5 text-5xl font-bold leading-tight tracking-tight`,
                children: `Every conversation holds an idea worth keeping.`,
              }),
              (0, j.jsx)(`p`, {
                className: `mt-6 text-lg leading-8 text-slate-300`,
                children: `Capture it, understand it, and act on it—all in one beautifully simple workspace.`,
              }),
            ],
          }),
          (0, j.jsx)(`p`, {
            className: `relative text-xs text-slate-500`,
            children: `Trusted by focused teams and lifelong learners.`,
          }),
        ],
      }),
      (0, j.jsxs)(`main`, {
        className: `relative flex items-center justify-center bg-slate-50 px-5 py-12`,
        children: [
          (0, j.jsxs)(Fn, {
            to: `/`,
            className: `absolute left-6 top-6 flex items-center gap-2 text-sm text-slate-500 hover:text-brand`,
            children: [(0, j.jsx)(cr, { size: 16 }), ` Back home`],
          }),
          (0, j.jsxs)(`div`, {
              ...
              (0, j.jsxs)(qr, {
                ...
                children: [
                  (0, j.jsx)(`h2`, {
                    ...
                    children: e ? `Create your account` : `Welcome back`,
                  }),
                  (0, j.jsx)(`p`, {
                  ...
                  (0, j.jsxs)(`form`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(Kr, {
                        ...
                        children: e ? `Create Account` : `Log in`,
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`p`, {
                    ...
                    children: [
                      e ? `Already have an account?` : `New to VoiceScribe?`,
                      ` `,
                      (0, j.jsx)(Fn, {
                        className: `font-semibold text-brand hover:underline`,
                        to: e ? `/login` : `/signup`,
                        children: e ? `Log in` : `Create Account`,
                      }),
                    ],
                  }),
                ],
...
var ti = () => (0, j.jsx)(ei, {}),
  ni = () => (0, j.jsx)(ei, { signup: !0 }),
  ri = [
    [`Dashboard`, wr, `/dashboard`],
    [`New Recording`, Ar, `/dashboard#record`],
    [`History`, Sr, `/dashboard#history`],
    [`Profile`, zr, `/dashboard#profile`],
    [`Settings`, Fr, `/dashboard#settings`],
  ];
function ii({ open: e, onClose: t }) {
  return (0, j.jsxs)(`aside`, {
    className: `fixed inset-y-0 left-0 z-50 flex w-[272px] flex-col border-r border-slate-200/70 bg-white/95 px-4 py-5 shadow-2xl shadow-slate-200/30 backdrop-blur-xl transition-transform duration-300 lg:translate-x-0 lg:shadow-none ${e ? `translate-x-0` : `-translate-x-full`}`,
    children: [
      (0, j.jsxs)(`div`, {
      ...
      (0, j.jsxs)(`nav`, {
        ...
        children: [
          (0, j.jsx)(`p`, {
            className: `mb-3 px-3 text-[10px] font-bold uppercase tracking-[.16em] text-slate-400`,
            children: `Workspace`,
          }),
          (0, j.jsx)(`div`, {
            className: `space-y-1`,
            children: ri.map(([e, n, r], i) =>
              (0, j.jsxs)(
                In,
                {
                  to: r,
                  onClick: t,
                  className: `group flex items-center gap-3 rounded-xl px-3 py-2.5 text-[13px] font-semibold transition-all duration-200 ${i === 0 ? `bg-gradient-to-r from-indigo-50 to-violet-50 text-indigo-600 shadow-sm ring-1 ring-indigo-100/60` : `text-slate-500 hover:translate-x-0.5 hover:bg-slate-50 hover:text-slate-900`}`,
                  children: [
                    (0, j.jsx)(n, {
                      size: 18,
      ...
      (0, j.jsxs)(`div`, {
        className: `mt-auto overflow-hidden rounded-2xl border border-indigo-100/80 bg-gradient-to-br from-indigo-50 via-white to-violet-50 p-4 shadow-sm`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `flex items-center justify-between`,
            children: [
              (0, j.jsx)(`span`, {
                className: `grid h-8 w-8 place-items-center rounded-lg bg-indigo-600 text-white shadow-md shadow-indigo-200`,
                children: (0, j.jsx)(Lr, { size: 15 }),
              }),
              (0, j.jsx)(`span`, {
                className: `rounded-full bg-white px-2 py-1 text-[9px] font-bold uppercase tracking-wide text-indigo-600 shadow-sm`,
                children: `Pro`,
              }),
            ],
          }),
          ...
          (0, j.jsx)(`p`, {
            ...
            children: `Unlimited recordings and smarter AI insights.`,
          }),
          (0, j.jsxs)(Kr, {
            className: `mt-4 w-full py-2.5 text-xs`,
            children: [`Upgrade plan `, (0, j.jsx)(mr, { size: 14 })],
          }),
        ],
      }),
      (0, j.jsxs)(`div`, {
        className: `mt-4 flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50/70 p-2`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `flex items-center gap-2`,
            children: [
              (0, j.jsx)(`span`, {
                className: `grid h-8 w-8 place-items-center rounded-lg bg-slate-900 text-[10px] font-bold text-white`,
                children: `AK`,
              }),
              (0, j.jsxs)(`div`, {
                children: [
...
function ai({ children: e }) {
  ...
  return (0, j.jsxs)(`div`, {
    className: `min-h-screen overflow-x-hidden bg-[#f6f7fb]`,
    children: [
      (0, j.jsx)(`div`, {
        className: `pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_75%_0%,rgba(99,102,241,.07),transparent_30%),radial-gradient(circle_at_15%_80%,rgba(139,92,246,.04),transparent_30%)]`,
      }),
      (0, j.jsx)(ii, { open: t, onClose: () => n(!1) }),
      t &&
        (0, j.jsx)(`button`, {
          "aria-label": `Close sidebar`,
      ...
      (0, j.jsxs)(`main`, {
        className: `relative lg:pl-[272px]`,
        children: [
          (0, j.jsxs)(`header`, {
            className: `sticky top-0 z-30 flex h-[76px] items-center justify-between border-b border-white/80 bg-white/75 px-4 backdrop-blur-xl sm:px-6 xl:px-8`,
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsx)(`button`, {
                    ...
                    onClick: () => n(!0),
                    className: `icon-button lg:hidden`,
                    children: (0, j.jsx)(kr, { size: 20 }),
                  }),
                  (0, j.jsxs)(`div`, {
                    children: [
                      (0, j.jsxs)(`p`, {
                        className: `text-base font-bold tracking-[-.02em] text-slate-950 sm:text-lg`,
                        children: [
                          `Welcome back, Amaan `,
                          (0, j.jsx)(`span`, {
                      ...
                      (0, j.jsx)(`p`, {
                        className: `hidden text-[11px] font-medium text-slate-400 sm:block`,
                        children: `Friday, June 20 · Your ideas are ready to flow`,
                      }),
                    ],
                  }),
                ],
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`label`, {
                    className: `hidden h-10 items-center gap-2.5 rounded-xl border border-slate-200/80 bg-white px-3 shadow-sm transition focus-within:border-indigo-300 focus-within:ring-4 focus-within:ring-indigo-50 md:flex`,
                    children: [
                      (0, j.jsx)(Pr, { size: 16, className: `text-slate-400` }),
                      (0, j.jsx)(`input`, {
                        className: `w-40 bg-transparent text-xs outline-none xl:w-52`,
                        placeholder: `Search recordings...`,
                      }),
                      (0, j.jsxs)(`span`, {
                        className: `flex items-center gap-0.5 rounded-md border bg-slate-50 px-1.5 py-1 text-[9px] font-semibold text-slate-400`,
                        children: [(0, j.jsx)(_r, { size: 9 }), `K`],
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`button`, {
                    ...
                    children: [
                      (0, j.jsx)(dr, { size: 18 }),
                      (0, j.jsx)(`span`, {
                        className: `absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-indigo-500 ring-2 ring-white`,
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`button`, {
                    className: `flex items-center gap-2 rounded-xl p-1.5 pr-2 hover:bg-white hover:shadow-sm`,
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-xs font-bold text-white shadow-md shadow-indigo-200`,
                        children: `AK`,
                      }),
                      (0, j.jsxs)(`span`, {
...
var oi = [
  ...
  si = {
    indigo: {
      tile: `from-indigo-50 to-violet-50/70 border-indigo-100/80`,
      icon: `bg-indigo-600 text-white shadow-indigo-200`,
      button: `text-indigo-600 group-hover:bg-indigo-600`,
    },
    blue: {
      tile: `from-blue-50 to-cyan-50/60 border-blue-100/80`,
      icon: `bg-blue-600 text-white shadow-blue-200`,
      button: `text-blue-600 group-hover:bg-blue-600`,
    },
    emerald: {
      tile: `from-emerald-50 to-teal-50/60 border-emerald-100/80`,
      icon: `bg-emerald-600 text-white shadow-emerald-200`,
      button: `text-emerald-600 group-hover:bg-emerald-600`,
    },
    amber: {
      tile: `from-amber-50 to-orange-50/60 border-amber-100/80`,
      icon: `bg-amber-500 text-white shadow-amber-200`,
      button: `text-amber-600 group-hover:bg-amber-500`,
    },
  },
  ci = ({ eyebrow: e, title: t, description: n }) =>
    (0, j.jsxs)(`div`, {
      children: [
        (0, j.jsx)(`p`, {
          className: `text-[11px] font-bold uppercase tracking-[.16em] text-indigo-500`,
          children: e,
        }),
        (0, j.jsx)(`h2`, {
          className: `mt-1 text-lg font-bold tracking-[-.02em] text-slate-950`,
          children: t,
        }),
        n &&
          (0, j.jsx)(`p`, {
...
function li() {
  return (0, j.jsx)(ai, {
    children: (0, j.jsxs)(`div`, {
      className: `mx-auto max-w-[1480px] space-y-7 p-4 pb-10 sm:p-6 sm:pb-12 xl:p-8`,
      children: [
        (0, j.jsxs)(`div`, {
          className: `animate-rise flex flex-col justify-between gap-3 sm:flex-row sm:items-end`,
          children: [
            (0, j.jsx)(ci, {
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsx)(`span`, {
                  className: `h-2 w-2 rounded-full bg-emerald-500 shadow-[0_0_0_4px_rgba(16,185,129,.12)]`,
                }),
        ...
        (0, j.jsxs)(`section`, {
          className: `grid gap-6 xl:grid-cols-[.82fr_1.55fr]`,
          children: [
            (0, j.jsxs)(qr, {
              id: `record`,
              className: `animate-rise overflow-hidden border-white/80 bg-gradient-to-b from-white to-indigo-50/40 p-6 text-center shadow-premium sm:p-7`,
              children: [
                (0, j.jsxs)(`div`, {
                ...
                (0, j.jsxs)(`div`, {
                  className: `relative mx-auto mt-7 grid h-28 w-28 place-items-center rounded-full bg-indigo-100/70 ring-8 ring-indigo-50`,
                  children: [
                    (0, j.jsx)(`span`, {
                      className: `absolute inset-0 animate-pulse-soft rounded-full border border-indigo-300/50`,
                    }),
                    (0, j.jsx)(`div`, {
                      className: `grid h-20 w-20 place-items-center rounded-full bg-gradient-to-br from-indigo-500 via-indigo-600 to-violet-700 text-white shadow-[0_18px_35px_rgba(79,70,229,.32)]`,
                      children: (0, j.jsx)(Ar, { size: 34, strokeWidth: 1.8 }),
                    }),
                  ],
                }),
                (0, j.jsx)(`p`, {
                  className: `mt-6 text-[13px] font-medium text-slate-500`,
                  children: `Press start when you're ready`,
                }),
                (0, j.jsx)(`p`, {
                  className: `mt-2 font-mono text-3xl font-semibold tracking-tight text-slate-950`,
                  children: `00:00:00`,
                }),
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsxs)(Kr, {
                      className: `py-3`,
                      children: [(0, j.jsx)(Ar, { size: 16 }), `Start`],
                    }),
                    (0, j.jsxs)(Kr, {
                      variant: `danger`,
                      className: `py-3`,
                      children: [
                        (0, j.jsx)(Rr, { size: 13, fill: `currentColor` }),
                        `Stop`,
                      ],
                    }),
                  ],
                ...
                (0, j.jsx)(`div`, {
                  className: `mt-5 flex h-14 items-center justify-center gap-[3px] overflow-hidden rounded-xl border border-indigo-100/60 bg-white/70 px-3`,
                  children: oi.map((e, t) =>
                    (0, j.jsx)(
                      `span`,
                      {
                        className: `wave-bar w-[3px] shrink-0 rounded-full bg-gradient-to-t from-indigo-600 to-violet-400`,
                        style: { height: e, animationDelay: `${t * 45}ms` },
                      },
                      t,
                    ),
                  ),
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsxs)(qr, {
                  className: `animate-rise animation-delay-100 overflow-hidden border-white/80 shadow-premium`,
                  children: [
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsxs)(`div`, {
                          ...
                          children: [
                            (0, j.jsx)(`span`, {
                              className: `grid h-8 w-8 place-items-center rounded-lg bg-emerald-50 text-emerald-600`,
                              children: (0, j.jsx)(Nr, { size: 16 }),
                            }),
                            (0, j.jsxs)(`div`, {
                              children: [
                                (0, j.jsx)(`h2`, {
                        ...
                        (0, j.jsxs)(`span`, {
                          className: `flex items-center gap-2 rounded-full bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-700`,
                          children: [
                            (0, j.jsx)(`i`, {
                    ...
                    (0, j.jsxs)(`div`, {
                      className: `relative min-h-[175px] px-5 py-5 sm:px-6`,
                      children: [
                        (0, j.jsx)(`div`, {
                          className: `max-h-36 overflow-y-auto pr-3 text-[14px] leading-7 text-slate-700 selection:bg-indigo-100`,
                          children: `Hello everyone. Today we're going to discuss the project roadmap for our upcoming release. First, we'll focus on the frontend improvements and then move to backend integration. After that, we'll test the complete flow, resolve open issues, and prepare the application for production.`,
                        }),
                        (0, j.jsxs)(`div`, {
                          className: `absolute bottom-4 right-5 flex gap-2`,
                          children: [
                            (0, j.jsx)(`button`, {
                              "aria-label": `Copy transcript`,
                              className: `icon-button`,
                              children: (0, j.jsx)(vr, { size: 15 }),
                            }),
                            (0, j.jsx)(`button`, {
                              "aria-label": `Download transcript`,
                              className: `icon-button`,
                              children: (0, j.jsx)(yr, { size: 15 }),
                            }),
                          ],
                        }),
                      ],
                ...
                (0, j.jsxs)(qr, {
                  className: `animate-rise animation-delay-200 border-white/80 p-5 shadow-premium sm:p-6`,
                  children: [
                    (0, j.jsxs)(`div`, {
                      className: `flex items-center justify-between`,
                      children: [
                        (0, j.jsxs)(`div`, {
                          children: [
                            ...
                            (0, j.jsx)(`p`, {
                              ...
                              children: `Transform this transcript instantly`,
                            }),
                          ],
                        }),
                        (0, j.jsx)(Br, {
                    ...
                    (0, j.jsx)(`div`, {
                      ...
                      children: Xr.map(
                        ({ icon: e, title: t, text: n, tone: r }) => {
                          let i = si[r];
                          return (0, j.jsxs)(
                            `button`,
                            {
                              className: `group min-h-40 rounded-2xl border bg-gradient-to-br p-4 text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${i.tile}`,
                              children: [
                                (0, j.jsx)(`span`, {
                                  className: `grid h-9 w-9 place-items-center rounded-xl shadow-lg ${i.icon}`,
                                  children: (0, j.jsx)(e, { size: 17 }),
                                }),
                                (0, j.jsx)(`h3`, {
                                  className: `mt-4 text-[13px] font-bold text-slate-900`,
                                  children: t,
                                }),
                                (0, j.jsx)(`p`, {
                                ...
                                (0, j.jsx)(`span`, {
                                  className: `mt-3 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white shadow-sm transition-all group-hover:text-white ${i.button}`,
                                  children: (0, j.jsx)(ur, { size: 13 }),
                                }),
                              ],
                            },
                            t,
        ...
        (0, j.jsxs)(`section`, {
          ...
          children: [
            (0, j.jsx)(ui, {
              ...
              color: `indigo`,
              children: (0, j.jsx)(`p`, {
                children: `The team aligned on the upcoming release roadmap, prioritizing frontend quality, backend integration, end-to-end testing, and a confident production launch.`,
              }),
            }),
            (0, j.jsx)(ui, {
              icon: kr,
                ...
                children: [
                  ...
                  (0, j.jsxs)(
                    `li`,
                    {
                      ...
                      children: [
                        (0, j.jsx)(`span`, {
                          className: `h-4 w-4 rounded-md border border-slate-300 bg-slate-50 transition hover:border-emerald-400`,
                        }),
                        e,
                      ],
                    },
        ...
        (0, j.jsxs)(qr, {
          id: `history`,
          className: `animate-rise overflow-hidden border-white/80 shadow-premium`,
          children: [
            (0, j.jsxs)(`div`, {
              className: `flex items-center justify-between border-b border-slate-100 px-5 py-5 sm:px-6`,
              children: [
                (0, j.jsxs)(`div`, {
                  children: [
                    (0, j.jsx)(`h2`, {
                      className: `font-bold tracking-tight`,
                      children: `Recent recordings`,
                    }),
                    (0, j.jsx)(`p`, {
                      className: `mt-1 text-xs text-slate-400`,
                      children: `Your latest captured conversations`,
                    }),
                  ],
                }),
                (0, j.jsxs)(`button`, {
                  className: `group flex items-center gap-1 text-xs font-semibold text-indigo-600`,
                  children: [
                    `View all `,
                    (0, j.jsx)(mr, {
                      size: 15,
            ...
            (0, j.jsx)(`div`, {
              ...
              children: Zr.map(([e, t, n], r) =>
                (0, j.jsxs)(
                  `div`,
                  {
                    className: `group grid items-center gap-3 px-5 py-4 transition-colors hover:bg-slate-50/80 sm:grid-cols-[1.5fr_1fr_.5fr_auto] sm:px-6`,
                    children: [
                      (0, j.jsxs)(`div`, {
                        ...
                        children: [
                          (0, j.jsx)(`button`, {
                            "aria-label": `Play ${e}`,
                            className: `grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-indigo-50 text-indigo-600 transition-all group-hover:bg-indigo-600 group-hover:text-white group-hover:shadow-md`,
                            children: (0, j.jsx)(Mr, {
                              size: 13,
                              fill: `currentColor`,
                            }),
                          ...
                          (0, j.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, j.jsxs)(`p`, {
                                className: `mt-0.5 text-[11px] text-slate-400 sm:hidden`,
                                children: [t, ` · `, n],
                              }),
                            ],
                          }),
                      ...
                      (0, j.jsxs)(`span`, {
                        ...
                        children: [(0, j.jsx)(gr, { size: 13 }), n],
                      }),
                      (0, j.jsx)(`button`, {
                        "aria-label": `More options for ${e}`,
                        className: `icon-button ml-auto`,
                        children: (0, j.jsx)(br, { size: 16 }),
                      }),
                    ],
                  },
                  e,
...
function ui({ icon: e, title: t, label: n, color: r, children: i }) {
  return (0, j.jsxs)(qr, {
    className: `group animate-rise border-white/80 p-5 shadow-premium transition-all duration-300 hover:-translate-y-1 hover:shadow-premium-hover sm:p-6`,
    children: [
      (0, j.jsxs)(`div`, {
        className: `flex items-center justify-between`,
        children: [
          (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsx)(`span`, {
                className: `grid h-9 w-9 place-items-center rounded-xl ${{ indigo: `bg-indigo-50 text-indigo-600`, blue: `bg-blue-50 text-blue-600`, emerald: `bg-emerald-50 text-emerald-600` }[r]}`,
                children: (0, j.jsx)(e, { size: 18 }),
              }),
              (0, j.jsxs)(`div`, {
                children: [
                  (0, j.jsx)(`h2`, {
          ...
          (0, j.jsx)(`button`, {
            className: `icon-button`,
            children: (0, j.jsx)(vr, { size: 14 }),
          }),
        ],
      }),
      (0, j.jsx)(`div`, {
        className: `mt-5 text-[13px] leading-6 text-slate-600`,
        children: i,
      }),
    ],
  });
...
function di() {
  return (0, j.jsxs)(Gt, {
    children: [
      (0, j.jsx)(Ut, { path: `/`, element: (0, j.jsx)(Qr, {}) }),
      (0, j.jsx)(Ut, { path: `/login`, element: (0, j.jsx)(ti, {}) }),
      (0, j.jsx)(Ut, { path: `/signup`, element: (0, j.jsx)(ni, {}) }),
      (0, j.jsx)(Ut, { path: `/dashboard`, element: (0, j.jsx)(li, {}) }),
      (0, j.jsx)(Ut, {
        path: `*`,
        element: (0, j.jsx)(Ht, { to: `/`, replace: !0 }),
      }),
    ],
  });
}
Wr.createRoot(document.getElementById(`root`)).render(
  (0, j.jsx)(x.StrictMode, {
    children: (0, j.jsx)(Nn, { children: (0, j.jsx)(di, {}) }),
  }),
);
